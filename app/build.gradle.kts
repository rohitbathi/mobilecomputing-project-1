...
val cameraxVersion = "1.2.3"  // Updated the version to the latest defined value
...
dependencies {
    ...
    // CameraX Core dependencies using the correct version variable
    ...
    // Accompanist Permissions dependency
